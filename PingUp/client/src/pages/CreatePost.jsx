...
const CreatePost = () =>{
    ...
    return (
        <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
            <div className='max-w-6xl-auto p-6'>
                {/* Title */}
                <div className='mb-8'>
                ...
                <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
                    ...
                    placeholder-gray-400' placeholder="What's happening?" onChange={(e)=>setContent(e.target.value)}
                    value={content}/>
    ...
    setImages(prevImages => {
        console.log('Previous images:', prevImages.length);
        const newImages = [...prevImages, ...selectedFiles];
        console.log('Total images after selection:', newImages.length);
        return newImages;
    });
    e.target.value = ''; // Reset input value to allow selecting same files again
}}/>
